    ...
    function renderWishlistItems() {
        ...
        if (wishlistedItems.length === 0) {
            ...
            <div class="wishlist-empty-state">
                ...
                <a href="products.html" class="wishlist-btn-shop" data-bs-dismiss="modal">
        ...
        wishlistedItems.forEach(product => {
            ...
            const oldPriceHTML = product.discount && product.oldPrice ? 
                `<span class="text-decoration-line-through text-muted ms-2" style="font-size: 0.8rem;">$${Number(product.oldPrice).toFixed(2)}</span>` : '';
